...
import static com.leagueofshadows.enc.storage.SQLHelper.TIME;
        ...
        if(cursor!=null) {
            if (cursor.moveToFirst()) {
                do {
                    ...
                    EncryptedMessage encryptedMessage = new EncryptedMessage(cursor.getString(cursor.getColumnIndex(MESSAGES_ID)), cursor.getString(cursor.getColumnIndex(MESSAGES_TO))
                            ...
                            , cursor.getString(cursor.getColumnIndex(MESSAGES_TIMESTAMP)), cursor.getInt(cursor.getColumnIndex(MESSAGES_TYPE)));
